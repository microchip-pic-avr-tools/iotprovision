...
from setuptools import setup, find_namespace_packages, __version__ as setuptools_version
# packaging.version.parse is nice to compare versions
from packaging.version import parse as version_parse

SETUPTOOLS_REQUIRED = "45.1.0"

if version_parse(setuptools_version) < version_parse(SETUPTOOLS_REQUIRED):
    raise ImportError("setuptools >= {} required, have {}".format(
        SETUPTOOLS_REQUIRED, setuptools_version))
...
PACKAGE_VERSION = {
    ...
    "minor": 10,  # Set the minor number
    "patch": 7,   # Set the patch number
...
# NOTE: Data files are specified in MANIFEST.in. No other method seems to work.
...
setup(
    ...
    url='https://github.com/microchip-pic-avr-tools/iotprovision',
    license='MIT',
